...
$app->group('/usuarios', function () {
  ...
  $this->delete('/{id}', \usuarioApi::class . ':BorraUno'))->add(\MWparaCORS::class . ':HabilitarCORSTodos');
...
$app->group('/movimientos', function () {
  ...
  $this->get('/{id}', \movimientoApi::class . ':TraeMovimientosDeUsuario');
  
  // $this->get('/tipo', \usuarioApi::class . ':TraeTodos');
